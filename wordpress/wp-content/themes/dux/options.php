...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => __('LOGO', 'haoui'),
		'id' => 'logo_src',
		'desc' => __('LOGO最大高：32PX，建议尺寸：140*32PX，格式：PNG', 'haoui'),
		'std' => 'http://www.itmeiti.com/wp-content/uploads/2015/06/logo.png',
		'type' => 'upload');
	...
	$options[] = array(
		...
		'id' => 'description',
		'std' => __('IT媒体为你带来互联网最新资讯、行业趋势、热点产品的深度分析，发掘互联网的价值', 'haoui'),
	...
	$options[] = array(
		...
		'desc' => __('友情链接写于此，网站地图可自行使用Sitemap插件自动生成', 'haoui'),
		'type' => 'textarea');
	...
	$options[] = array(
		...
		'std' => '',
		'desc' => __('此处存放百度自定义站内搜索代码，请自行去http://zn.baidu.com/设置并获取', 'haoui'),
		'settings' => array(
			'rows' => 2
		),
		'type' => 'textarea');
	...
	$options[] = array(
		...
		'type' => "radio",
		'options' => array(
			'thumb' => __('图文（缩略图尺寸：220*132PX，默认已自动裁剪）', 'haoui'),
			'text' => __('文字 ', 'haoui')
		));
/*
	$options[] = array(
		...
		'type' => "checkbox",
		'std' => false,
		'desc' => __('缩略图使用外链图片（外链是没有缩略图的，所以不会是小图，不建议外链图，但如果你的文章都是外链图片，这个可以帮你实现以上的列表模式） ', 'haoui'));*/
...
/*
	...
	$options[] = array(
		...
		'desc' => __('链接', 'haoui'),
		'std' => 'http://ai.taobao.com/?pid=mm_56107078_9088255_30806151',
		'type' => 'text');
	...
	$options[] = array(
		...
		'desc' => __('微信二维码，建议图片尺寸：', 'haoui').'200*200PX',
		'type' => 'upload');
